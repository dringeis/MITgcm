...
C     allow the use of the Mohr Coulomb rheology (runtime flag SEAICEuseFULLMC) 
C     as defined in (Ip 1991) /!\ This is known to give unstable results, use with caution
# define SEAICE_ALLOW_FULLMC
C     allow the use of Mohr Coulomb with elliptical plastic potential (runtime flag SEAICEuseMCE)
