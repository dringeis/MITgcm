...
C     use with caution
# define SEAICE_ALLOW_MCS

CMLC     or the modified coulombic rheology
CMLC     allow the use of the Mohr Coulomb rheology (runtime flag
CMLC     SEAICEuseFULLMC) as defined in (Ip 1991) /!\ This is known
CMLC     to give unstable results, use with caution
CML# define SEAICE_ALLOW_FULLMC
